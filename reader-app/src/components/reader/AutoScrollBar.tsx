...
export function AutoScrollBar({
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-[calc(4.5rem+env(safe-area-inset-bottom,0px))] sm:bottom-18 left-1/2 -translate-x-1/2 z-40 flex items-center gap-2 rounded-2xl bg-zinc-950/90 dark:bg-zinc-900/95 text-white px-3.5 py-2.5 shadow-2xl backdrop-blur-2xl border border-white/15 select-none"
      dir="rtl"
    >
      {/* Play/Pause Button */}
      <button
