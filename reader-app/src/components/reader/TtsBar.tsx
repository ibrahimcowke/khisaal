...
export function TtsBar({
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-[calc(4.5rem+env(safe-area-inset-bottom,0px))] sm:bottom-18 left-1/2 -translate-x-1/2 z-40 flex items-center gap-2 rounded-2xl bg-app-surface/95 backdrop-blur-xl border border-app-accent/40 text-app-text px-4 py-2.5 shadow-2xl select-none"
    >
