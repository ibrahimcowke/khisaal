      ...
      <div
        ...
        className={cn(
          ...
          s.readingMode === 'paginated'
            ...
            : 'pt-[calc(4.85rem+env(safe-area-inset-top,0px))] pb-[calc(6rem+env(safe-area-inset-bottom,0px))] pl-[max(env(safe-area-inset-left,0px),1rem)] pr-[max(env(safe-area-inset-right,0px),1rem)]'
        )}
        style={{
